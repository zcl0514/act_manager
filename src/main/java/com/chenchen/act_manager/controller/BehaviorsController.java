...
public class BehaviorsController {
    ...
    public List<WordInfo> behaviors() {
        return wordService.getWordInfos();
    }
    ...
    @PostMapping("/behaviors")
    public Boolean save(@RequestParam WordInfo wordInfo) {
        return wordService.save(wordInfo);
    }
    ...
    public ResponseEntity<ByteArrayResource> export() {
        // 生成Word文档字节数组
        byte[] wordBytes = wordService.export(wordService.getWordInfos());
